...
# Create regularly spaced steps (4 hours, 8 hours during the day). Hence, keep
# only fixes collected during the following hours: 3, 7, 15, 19, 23
...
# Create step id and indicate if case or control step
...
writeOGR(lines
  ...
  , layer     = "00_General_Dispersers_Popecol(SSF)"
