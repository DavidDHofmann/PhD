...
# ################################################################################
# # Read in data
# dat_old <- read_csv("/home/david/ownCloud/University/15. PhD/Chapter_0/03_Data/02_CleanData/00_General_Dispersers_Popecol(SSF4Hours).csv")
# dat_old <- subset(dat_old, case_)
# dat_old <- dat_old %>% dplyr::select(c(id, t1_))
# dat_new <- read_csv("/home/david/ownCloud/University/15. PhD/Chapter_1/03_Data/02_CleanData/00_General_Dispersers_POPECOL(SSF).csv")
# dat_new <- subset(dat_new, case_)
# dat_new <- dat_new %>% dplyr::select(c(id = DogName, t1_))
# nrow(dat_new) - nrow(dat_old)
# anti_join(dat_old, dat_new)
