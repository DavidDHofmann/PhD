...
# Store it to file
ggsave(plot = p1, "Heatmap1.png", bg = "transparent")
ggsave(plot = p2, "Heatmap2.png", bg = "transparent")
ggsave(plot = p3, "Heatmap3.png", bg = "transparent")
...
p <- ggarrange(maps[[2]], maps[[4]], maps[[6]], maps[[8]], maps[[10]], maps[[12]], ncol = 3, nrow = 2)

# Store the arranged plot
ggsave("HeatmapsIndividual.png"
  , plot   = p
  , scale  = 2.5
  , height = 4
  , width  = 6
