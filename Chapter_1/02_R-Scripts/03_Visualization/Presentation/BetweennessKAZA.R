...
# Store it to file
ggsave(plot = p1, "Betweenness1.png", bg = "transparent")
ggsave(plot = p2, "Betweenness2.png", bg = "transparent")
ggsave(plot = p3, "Betweenness3.png", bg = "transparent")
...
ggsave("BetweennessIndividual.png"
  , plot   = p
  , scale  = 3
  , height = 2
  , width  = 6
