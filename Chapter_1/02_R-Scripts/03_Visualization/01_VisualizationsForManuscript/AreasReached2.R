...
visits <- read_rds("03_Data/03_Results/99_AreasReached2.rds")

# Load network areas and points
areas <- readOGR("03_Data/03_Results/99_NetworkAreas.shp")
points <- readOGR("03_Data/03_Results/99_NetworkPoints.shp")

# Prepare layout
lay <- coordinates(points)
...
# Prepare network for plotting with ggplot
