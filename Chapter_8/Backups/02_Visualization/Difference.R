...
p1 <- read_rds("03_Data/03_Results/HeatmapsDifference.rds")
p2 <- read_rds("03_Data/03_Results/BetweennessDifference.rds")
p3 <- read_rds("03_Data/03_Results/DistanceDifference.rds")
...
p <- ggarrange(p1, p2, p3, nrow = 1, align = "hv", labels = "auto", label.x = 0.05)
ggsave("04_Manuscript/99_Difference.png", p, width = 10, height = 3.5, bg = "white")
