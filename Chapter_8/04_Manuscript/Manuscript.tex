...
increases chances of successful dispersal into neighboring habitat patches by xx
percent. Concomitantly, dispersal durations to move between patches is reduced,
on average by xx days,at low flood levels.
...
this area. Our analysis suggests that anticipating such alterations in
environmental conditions is key when implementing conservation strategies.
Besides a better understanding of the conservation needs for the African wild
dog, our study also presents a first step towards incorporating environmental
changes due to seasonality or climate change in dispersal and connectivity
analyses and demonstrates the usefulness of individual-based dispersal
simulations as a pertinent conservation tool to study impacts of environmental
change on dispersal success.
