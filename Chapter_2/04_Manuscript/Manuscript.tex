...
We attempted to represent each spatial covariate at the highest temporal
resolution available, which resulted in various degrees of temporal accuracy. In
order to generate spatial layers that depict the flood extent at different
