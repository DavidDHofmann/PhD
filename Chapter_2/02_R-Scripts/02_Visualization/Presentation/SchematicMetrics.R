...
library(pbmcapply)   # Multicore apply with progress bar
library(spatstat)    # To handle spatial data
library(maptools)    # To handle spatial data
...
# Store plots
ggsave(plot = p1, "05_Presentation/Figures/SchematicSimulations.png")
ggsave(plot = p2, "05_Presentation/Figures/SchematicHeatmap.png")
ggsave(plot = p3, "05_Presentation/Figures/SchematicBetweenness.png")
ggsave(plot = p4, "05_Presentation/Figures/SchematicHWC.png")
