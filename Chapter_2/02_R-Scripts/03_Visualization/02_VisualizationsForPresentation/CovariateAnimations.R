...
water1 <- rast("/home/david/ownCloud/University/15. PhD/Chapter_2/03_Data/02_CleanData/01_LandCover_WaterCoverStatic.tif")
water2 <- rast("/home/david/ownCloud/University/15. PhD/Chapter_2/03_Data/02_CleanData/03_LandscapeFeatures_Rivers.tif")
water1[ext] <- 0
