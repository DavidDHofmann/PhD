...
src <- data.frame(
    x  = c(23.75, 23.4, 22.7, 21.8, 22.7)
  , y  = c(-19.4, -18.8, -18.3, -19.2, -20.1)
  , ID = 1:5
)
...
# Visualize all
plot(ext(areas))
plot(wat, col = "cornflowerblue", border = NA, add = T)
...
# Compute size of this "core study area"
round(expanse(out, unit = "km"))
...
readr::write_rds(session, file = "02_R-Scripts/99_SessionInformation/02_SourceAreas.rds")
