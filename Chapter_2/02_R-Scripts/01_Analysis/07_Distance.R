...
# We can use this to identify the number of trajectories running towards
# human-dominated areas. Unfortunately, this does not account for shifts in the
# areas where HWC occurs
sims %>% count(SourceArea, FloodLevel)
...
readr::write_rds(session, file = "02_R-Scripts/99_SessionInformation/07_Distance.rds")
