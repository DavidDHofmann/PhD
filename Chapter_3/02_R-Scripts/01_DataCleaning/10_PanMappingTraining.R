...
ggplot(st_as_sf(classes), aes(col = Class, fill = Class)) +
  ...
  facet_wrap("Date") +
  theme_minimal() +
  theme(strip.background = element_rect(fill = "grey95", color = "transparent"))
