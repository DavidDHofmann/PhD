...
write_rds(disp, "03_Data/02_CleanData/Windows.rds")
...
write_rds(dat, "03_Data/03_Results/SentinelResults.rds")
dat <- read_rds("03_Data/03_Results/SentinelResults.rds")
