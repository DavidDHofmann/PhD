...
data <- resFix(data = data, hours = 2, start = 1, individual = "DogName")
...
# To store the shapefiles we need to coerce the difftime column to a numeric
# column
