...
\newpage
\begin{abstract}
Protecting large portions of natural land connecting natural reserves is an
increasingly used strategy to maintain and restore connectivity among wildlife
subpopulations. One such initiative area is the Kavango-Zambezi Transfrontier
Conservation Area (KAZA-TFCA) in Africa, the world's largest transboundary
conservation area on earth, spanning five countries and 520'000
km\textsuperscript{2}. While boundaries of such conservation areas are often
determined by expert opinion as well as socio-political needs and constraints,
the extent to which these areas match species' movement corridors is rarely
examined. This is mainly due to a lack of adequate empirical data, particularly
on dispersal. Between 2011 and 2019, we collected high-resolution GPS relocation
data on 16 dispersing African wild dog coalitions (\textit{Lycaon pictus}) to
(i) measure differences in landscape permeability within and outside the
boundaries of the KAZA-TFCA and (ii) to assess to which degree the area of the
KAZA-TFCA reflects natural movement corridors of this highly mobile and
endangered species. We show that permeability within the KAZA-TFCA boundaries
was more than double compared to areas outside it. Furthermore, we identify a
five-fold permeability difference among the five KAZA-TFCA countries. These
differences were mainly caused by different degrees of human activities,
hampering dispersal movements. We further show that all major movement corridors
of wild dogs run within the KAZA-TFCA boundaries, although some minor corridors
remain outside formally protected areas. Our work highlights the importance of
empirically assessing the adequacy of protected areas and the need for
international coordination that stem from different contributions to
connectivity across regions and countries.
\end{abstract}
...
\Cref{EQ1} to our spatial covariates and calculated the selection score \(w(x)\)
