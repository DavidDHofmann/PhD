...
decomposing piece of cloth.\todo{Editor desired more information on GPS collar}
...
\beta_2, ..., \beta_n\)). To estimate relative selection strengths \todo{As per
reviewer 1} (i.e. the \(\beta\)'s), we used mixed effects conditional logistic
...
covariates.\todo{Reviewer 1 asked for more details in the random effects. I
therefore decided to update this section too} The inclusion of movement metrics
served to reduce biases in estimated habitat selection coefficients \todo{as per
revierwer 1} that may have arisen due to movement behavior \citep{Avgar.2016}.
