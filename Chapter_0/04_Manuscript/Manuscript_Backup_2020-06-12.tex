...
wildlife populations. Boundaries of such conservation areas are, however, often
determined based on expert opinion and socio-political constraints, but the
...
such as dispersal. Yet, empirically assessing the adequacy of protected areas is
key for the implementation of targeted management actions and use of limited
conservation funds.
...
example of international conservation efforts. We used an integrated step
selection analysis to create a permeability surface for the KAZA-TFCA. We then
compared landscape permeability across different regions within the KAZA-TFCA as
well as outside its boundaries. Lastly, we calculated least-cost paths and
corridors to verify that major movement corridors are adequately encompassed
...
permeability difference among the five countries. We further showed that major
movement corridors of wild dogs run within the KAZA-TFCA boundaries, although
some minor corridors remained outside formally protected areas.

\noindent 4. Differences in permeability were mainly caused by different degrees
of human activities across regions, which hampered dispersal. Rivers and swamps
also limited dispersal, while other landscape features had a limited effect.
...
evaluate the adequacy of already-existing protected areas or could be used for
the planning of future such initiatives. Furthermore, the ability to reveal
regional differences in landscape permeability is fundamental for a coordinated
effort towards maintaining or restoring connectivity, especially where
...
KAZA-TFCA (\Cref{LeastCost}b). Our model did not detect any significant direct
