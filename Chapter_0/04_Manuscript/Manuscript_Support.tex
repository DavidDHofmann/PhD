...
%------------------------------------------------------------------------------
\section{Net Squared Displacement}\todo{Reviewer 1 pointed out that we need to
replace calssified with classified}
\begin{figure}[hbpt]
  \begin{center}
    ...
    \resizebox{\textwidth}{!}{
      \begin{threeparttable}
        ...
        \toprule
          ...
          \midrule
          cos(ta) + log(sl) + W + T + DTW + HI + S & 90091.40 & 0.00 & 1.00 & -45030.70 \\
          cos(ta) + log(sl) + W + T + DTW + HI + S + DTR & 90093.51 & 2.11 & 0.00 & -45029.75 \\
          cos(ta) + log(sl) + W + T + DTW + HI & 90094.79 & 3.38 & 0.00 & -45034.39 \\
          cos(ta) + log(sl) + W + T + DTW + HI + S + P & 90095.05 & 3.65 & 0.00 & -45030.52 \\
          cos(ta) + log(sl) + W + T + DTW + S & 90096.95 & 5.55 & 0.00 & -45035.47 \\
          cos(ta) + log(sl) + W + T + DTW + HI + DTR & 90097.02 & 5.62 & 0.00 & -45033.51 \\
          cos(ta) + log(sl) + W + T + DTW + HI + S + DTR + P & 90097.38 & 5.98 & 0.00 & -45029.69 \\
          cos(ta) + log(sl) + W + T + DTW + HI + S + RC & 90097.53 & 6.13 & 0.00 & -45029.76 \\
          cos(ta) + log(sl) + W + T + DTW + HI + P & 90098.46 & 7.06 & 0.00 & -45034.23 \\
          cos(ta) + log(sl) + W + T + DTW + HI + S + DTR + RC & 90099.62 & 8.22 & 0.00 & -45028.81 \\
          cos(ta) + log(sl) + W + T + DTW & 90099.97 & 8.57 & 0.00 & -45038.99 \\
          cos(ta) + log(sl) + W + T + DTW + HI + RC & 90100.68 & 9.28 & 0.00 & -45033.34 \\
