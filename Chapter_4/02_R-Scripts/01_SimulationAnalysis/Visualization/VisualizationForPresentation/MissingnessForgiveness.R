...
p1 <- ggplot(all
  ...
  geom_segment(lineend = "round", linewidth = 7, alpha = 0.75) +
  geom_segment(aes(linetype = valid), color = "white") +
  geom_point(size = 5) +
  geom_text(
...
# Store plot to file
ggsave("05_Presentation/99_Overview.png"
  , plot   = p
  , bg     = "transparent"
  , width  = 6
  , height = 4
