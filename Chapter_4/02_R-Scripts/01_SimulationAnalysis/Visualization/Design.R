...
# Create maps
dir.create("04_Manuscript/99_Design", showWarnings = F)
lapply(1:nrow(dat_cov), function(x) {
  ...
  ggsave(file.path("04_Manuscript/99_Design", filename), bg = "white", scale = 2)
})
...
# Store
ggsave("04_Manuscript/99_Design/CovariatesLegend.png"
  , plot   = l
  , scale  = 1.4
  , device = png
  , bg     = "white"
...
p  <- ggplot(dat, aes(x = x, y = y, color = Obtained)) +
  ...
  scale_color_manual(values = c("gray85", "black"), name = "location obtained") +
  theme_void() +
  theme(
      legend.position  = "bottom"
...
# Store main plot
ggsave("04_Manuscript/99_Design/Missingness.png"
  , plot   = p
  , scale  = 1.4
  , device = png
  , bg     = "white"
...
# Store legend
ggsave("04_Manuscript/99_Design/MissingnessLegend.png"
  , plot   = l
  , scale  = 1.4
  , device = png
  , bg     = "white"
...
# Store main plot
ggsave("04_Manuscript/99_Design/Forgiveness.png"
  , plot   = p
  , scale  = 0.8
  , device = png
  , bg     = "white"
...
# Store legend
ggsave("04_Manuscript/99_Design/ForgivenessLegend.png"
  , plot   = l
  , scale  = 1.4
  , device = png
  , bg     = "white"
...
# Store the legend
ggsave(
    filename = "04_Manuscript/99_Design/ApproachLegend.png"
  , plot     = legend
  , width    = 3.5
  , height   = 0.3
  , bg       = "white"
...
ggsave("04_Manuscript/99_Design/ApproachUncorrected.png"
  , plot   = p_uncorrected
  , bg     = "white"
  , width  = 15
  , height = 4.5
...
ggsave("04_Manuscript/99_Design/ApproachNaive.png"
  , plot   = p_uncorrected
  , bg     = "white"
  , width  = 15
  , height = 4.5
...
ggsave("04_Manuscript/99_Design/ApproachDynamic.png"
  , plot   = p_dynamic
  , bg     = "white"
  , width  = 15
  , height = 4.5
